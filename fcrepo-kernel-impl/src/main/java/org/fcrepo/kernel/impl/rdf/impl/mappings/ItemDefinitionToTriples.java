 ...
 * @param <T>
 */
public class ItemDefinitionToTriples<T extends ItemDefinition> extends Function1<T, Iterable<Triple>> {
    ...
    @Override
    public Iterable<Triple> call(final T input) throws RepositoryException {
